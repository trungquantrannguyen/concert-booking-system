...
function FeaturedEvents(){
  ...
  return(
        <div className="container-fluid" id="featured-events">
            <h1>Featured Events</h1>
            <div className="featured-events-list">
                {concert_list.map((item,index) => {
                    return (
                        <div key={index} className="featured-events-list-item">
                            <img src={item.concert_img} className="img-fluid" alt=""/>
            ...
            <div className="featured-events-list">
                {genres_list.map((item,index) => {
                    return (
                        <div key={index} className="featured-events-list-item">
                            <button className="genres-btn" type="button">{item.genre_name}</button>
                        </div> 
                    )
                })}
            </div>
